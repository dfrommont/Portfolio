        ...
        <>
            <div className="conatiner-fluid" style={{backgroundColor: "var(--jet)"}}>
                ...
                <div className="container p-5">
                    ...
                    <p className="text-start h5 text-light">Towards the end of my first year of university I applied to join the HackSussex committee following an exciting year of taking part in their events. Following the initial application I was invited to join the committee for 2023. Since then I have gone on to get involved in a number of HackSussex projects.</p>
                    ...
                    <p className="text-center h6 text-light mx-3 fst-italic p-3">During the summer between first and second year of university I joined the website team. Alongside a fellow committee member, I spent a few weeks building the skeleton of the website and then once more people were available, we finished the design and then built the full build of the site.<br />The website is built using React and Bootstrap to build and then styled components ensuring that they are responsive to all screen sizes.<br /><br />Before joining the website team I was relatively inexperienced with web development having only used basic html and css in the past to build simple websites so I was able to learn a lot during this time with the website, getting to really work on my web-dev skills as well as gain more experience working both in a group and to a time schedule.</p>
                </div>
